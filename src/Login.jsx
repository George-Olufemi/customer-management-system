    ...
    <React.Fragment>
        ...
        <form class="w-full max-w-sm">
            ...
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                <Link to="/dashboard">
                    <button onClick={successToast} class="shadow bg-black hover:bg-gray-800 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded-lg hover:scale-105 transition-all hover:shadow-2xl" type="button">
                        Login
                    </button>
                    <ToastContainer />
                </Link>
