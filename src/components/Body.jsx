...
const Body = () => {
  return (
    <React.Fragment>
      <div>
          <div className="body h-screen md:px-10 bg-fixed">
          <Slide top>
            ...
            <div>
              ...
              <div className='text-center flex justify-center items-center mt-12 text-2xl'>
                  <Link to="/signup">
                      <button className="bg-black text-white text-2xl px-3 py-1 md:px-4 md:py-2 rounded-lg tracking-wider md:font-semibold hover:bg-gray-900 hover:text-white hover:scale-110 transition-all">Get Started</button>
                  </Link>
              </div>
          </div>
      </div>
