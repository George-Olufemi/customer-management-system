    ...
    <React.Fragment>
      <div>
          <div className="body h-screen md:px-10 bg-fixed bg-contain">
            ...
            {/* Text Area */}
            <div>
                <div className="text-white text-4xl md:text-7xl font-bold tracking-wider leading-normal pt-10 md:pt-16 text-center">
              ...
              <div className='text-center flex justify-center items-center mt-10'>
                  <Link to="/signup">
                      <button className="bg-black text-white text-xl py-2 rounded-lg tracking-wider md:font-semibold hover:bg-gray-900 hover:text-white hover:scale-110 transition-all">Get Started</button>
                  </Link>
              </div>
          </div>
      </div>
